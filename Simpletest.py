...
##########################################################
'''
Simpletest.py is used to find subcluster has significant insertion resulted by calling-cards transposon.
...
parser.add_argument("--f",dest="fake", type=str, default=['0.05'], nargs=1, help="Set the pseudocount_value")
parser.add_argument("--a",dest="Alpha", type=str, default=['0.05'], nargs=1, help="Set the alpha value")
parser.add_argument("--o",dest="out", type=str, nargs=1, help="The directory contains QTout/ and PrecutOut/")
...
print "The pseudo-count value is: "+pseudo
print "The alpha value is: "+alpha

'''
   Function _TEST_: Test the Null Hypothesis that the EXP == WT.
	#1.Poisson distribution.
	# Test statistics: Pr(X>=exp-hop|WT)
...
summary=[]
outfile_name=output+'Total_Insertions_P_value.txt'
infile_name=output+'QTout/CCTest_Combine.csv'
bkgtotal=output+'PrecutOut/WT/combine.txt'
