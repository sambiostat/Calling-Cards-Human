...
parser.add_argument("--r",dest="ref", type=str, nargs=1,default=".", help="Type the path and name for reference genome <../../ref.Sorted.bed>")
parser.add_argument("--o",dest="out", type=str, nargs=1,default=".", help="Type the name of Output folder, <../../ouput/>")

args=parser.parse_args()
Ref=args.ref[0]
outfolder=args.out[0]
Local=outfolder+'/Total_Insertions_P_value.txt'
